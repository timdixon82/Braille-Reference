# Security Review: Braille-Reference

This document records the security review for Braille-Reference, carried out by Jed (penetration testing and security governance). It covers the OWASP Top 10 assessment, any findings, and the release condition.
