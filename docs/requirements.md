# Requirements: Braille-Reference

This document records the requirements for Braille-Reference. It is produced during the Tad (business analyst) pass and is the contract that the architect, developer, and tester work from.
